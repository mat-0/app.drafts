...
let auth = () => {
    ...
    let cred = Credential.create(
        "GitHub Gist",
        'Enter personal access token for the GitHub API generated from your developer page at GitHub.com (https://github.com/settings/tokens). This token should have permissions for the scope "gist" to allow creation of Gists.'
    );
