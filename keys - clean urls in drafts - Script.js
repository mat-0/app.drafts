...
const trackingParams = [
    ...
    // Amazon
    'ref_', 'ref', 'psc', 'pd_rd', 'qid', 'sr',
    
    // Other common tracking
    'mc_cid', 'mc_eid', '_ga', '_ke', 'trk', 'trkid',
    'hsCtaTracking', 'hsLang', '_hsenc', '_hsmi',
    'mkt_tok', 'vero_id', 'wickedid',
    'yclid', 'srsltid'
];
...
// Show results
if (replacements > 0) {
    app.displaySuccessMessage('Cleaned ' + replacements + ' URL' + (replacements === 1 ? '' : 's'));
} else {
